...
class Feature(Base):
    ICONE_CHOICES = (
        ('lni-rocket', 'Foquete'),
        ('lni-laptop-phone', 'Laptop e e Celular'),
        ('lni-cog', 'Engrenagem'),
        ('lni-leaf', 'Folha'),
        ('lni-layers', 'Design'),
        ('lni-leaf', 'Folha'),
    ...
    nome = models.CharField('Feature', max_length=100)
    descricao = models.TextField('Descrição', max_length=500)
    icone = models.CharField('Icone', max_length=20, choices=ICONE_CHOICES)
    posicao = models.CharField('Posição', max_length=1, choices=POSICAO_CHOICES, default='e')
